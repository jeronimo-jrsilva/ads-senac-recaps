...
## 💻 Guia de Compilação e Execução Multiplataforma (C)

Comandos para compilar o código fonte e executar em cada ambiente:

```bash
# 🐧 Linux (Terminal Bash / GCC)
gcc -Wall -Wextra aula01.c -o aula01 && ./aula01

# 🪟 Windows (PowerShell / CMD / MinGW GCC)
gcc -Wall -Wextra aula01.c -o aula01.exe; .\aula01.exe

# 🍏 macOS (Terminal Zsh / Clang LLVM)
clang -Wall -Wextra aula01.c -o aula01 && ./aula01
```
