...
VAULT_ROOT = Path("/home/jeronimo/G-Sync/MultiPurpose")
SEMANAL_DIR = VAULT_ROOT / "02_Cérebro/📖 Estudos/01_Graduação/01_Semestre/Semanal"
    ...
    <div class="main-container">
        ...
        <header class="app-header">
            <div class="brand">
                ...
                <span class="brand-badge">2026.1</span>
            </div>
            <div class="header-actions">
                ...
                <div class="semester-pills">
                    <a href="Recap_Master_S1.html" class="sem-link active">2026.1</a>
                    <a href="Recap_Master_S2.html" class="sem-link">2026.2</a>
                </div>
            </div>
        </header>
                ...
                <div class="lesson-card hero-card">
                    ...
                    <div class="hero-header-row">
                        <div class="hero-brand-col">
                            <h1 class="hero-title">Dashboard Semestral — 2026.1</h1>
                            <div class="hero-subtitle">Análise e Desenvolvimento de Sistemas • 1º Semestre</div>
                        </div>
                    ...
                    <details class="collapsible-section" open>
                        <summary>Visão Temporal do 1º Semestre</summary>
            ...
            <section id="glossary" class="spa-section">
                <div class="lesson-card">
                    <div style="border-bottom: 1px solid var(--border); padding-bottom: 15px; margin-bottom: 25px;">
                        <h1 style="font-size: 1.8rem; margin:0; color:#fff;">Glossário Técnico Cruzado (2026.1)</h1>
    ...
    <div id="search-modal" class="search-modal-backdrop" onclick="handleBackdropClick(event)">
        <div class="search-modal-box">
            <div class="search-input-wrapper">
                ...
                <input type="text" id="search-input" placeholder="Digite para pesquisar em todas as aulas, códigos ou glossário de 2026.1..." oninput="handleSearch(this.value)" autocomplete="off">
                <button class="search-close-btn" onclick="closeSearchModal()">Esc</button>
            </div>
            <div id="search-results" class="search-results-list">
                <div class="search-empty-state">Digite algo para buscar (ex: <code>ponteiro</code>, <code>pipeline</code>, <code>LGPD</code>, <code>Nator</code>, <code>array</code>)...</div>
            </div>
        </div>
    </div>
...
"""
    ...
    for folder in sorted(week_folders, reverse=False):
        ...
        md_files = [f for f in md_files if f.name not in ["week_config.json", "synthesis_context.txt"]]
        ...
        for file in md_files:
            ...
            if "feriado" in file.name.lower():
                lesson_num = "Feriado"
            elif "avaliacao" in file.name.lower() or "avaliação" in file.name.lower():
                lesson_num = "Avaliação"
            else:
    ...
    for m in [2, 3, 4, 5, 6]:
        ...
        m_name = ["Fevereiro", "Março", "Abril", "Maio", "Junho"][m-2]
    ...
    (REPO_ROOT / "Recap_Master_S1.html").write_text(final_html, encoding="utf-8")
